...
NumRow                  = 12 
ProbInfection           = 0.10      #probability of infection per contact - modified from 0.2 to 0.1
BetaDefault             = (2.5/10)
BetaOneEsc              = (2.5/10)
BetaTwoEsc              = (2.5/10)
LatentRate              = 4/4
...
def parameter_vector(QuarantineLength, MaxEscapeRateDay14, EscapeFunctionSlope, PerfectCompliance = 0, NOQuarantine = 0, NewQuarantineEndRate = 0, EscapeFunctionNum = 0):
    ...
    param_define[-7]=   int(PerfectCompliance == 0)*(   1*int(QuarantineLength == 14)                   + \
                                                        ...
                                                        EscapeFunctionSlope**2*int(QuarantineLength == 5)  ) #modified on 7/7/2021, deleted unneccessary parts on 8/5/2021
...
def scenario_machine(
    ...
    x0[(NumQuarantineCmp + 3)*2] = L1Proportion            
    x0[0] = 1 - L1Proportion
